...
function App() {
  ...
  const questionList = [
    ...
    a:[{type:'P',text:'ㅇㅇ 국밥먹고 바다가서 놀다가 카페가자'},
       {type:'J',text:'7시30분 만나서, 8시 할매국밥, 9시 박물관, 11시 해수욕장, 12시 카페'}]},
  ...
  function setMbti(){
    let mc = [
      ...
      {mbti:'ISFP',contents:['노는 거 은근 좋아해요','근데 집에 있는 것도 좋아해요','마이웨이 성향이 강해요']},
